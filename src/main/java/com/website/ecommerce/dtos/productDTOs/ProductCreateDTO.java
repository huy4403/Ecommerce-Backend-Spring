package com.website.ecommerce.dtos.productDTOs;
...
public class ProductCreateDTO {
    ...
    public ProductCreateDTO(String name, Integer quantity, Integer importPrice, Integer price, String description, Category category) {
        this.name = name;
